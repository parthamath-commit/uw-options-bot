...
try:
    from schwab import auth as _schwab_auth_test
...
class SchwabBroker:
    ...
    def get_option_quote(self, symbol, expiry, strike, right):
        ...
        try:
            ...
            # schwab-py requires ContractType enum, not plain string
            # Enum lives at schwab.client.Client.Options.ContractType
            from schwab.client import Client as _SC
            contract_type = (
                _SC.Options.ContractType.CALL
                if right == "C"
